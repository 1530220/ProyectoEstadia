            ...
            <div class="row"> 
              ...
              <div class="col-md-12">
                <ul class="nav nav-tabs">
                  <li class="active"><a data-toggle="tab"><i class="fas fa-edit"></i>Editar Perfil</a></li>
                </ul>
              </div>
                      ...
                      <div class="col-md-8"> 
                        <div class="sidebar">
                                <form method="post" action="/editar_egresado/{{auth()->user()->id}}" files="true" enctype="multipart/form-data">
                                    ...
                                    <input type="text" name="image_2" hidden value="{{ $user->image_url }}" style="color:black;" readonly>
                                    </div>
                                    ...
                                    <br>
                                    <br>
                                    <a href="/perfil_egresado/{{auth()->user()->id}}"><button type="button" class="btn btn-secondary">Regresar Perfil</button></a>
                                    </div>
                                    </div>
                                    @endforeach
                                    </div>
