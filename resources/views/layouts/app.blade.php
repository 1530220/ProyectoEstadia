                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification">
                                <a href="#!">
                                    ...
                                    <span>{{ Auth::user()->title }} {{ Auth::user()->first_name }} {{Auth::user()->last_name}} {{Auth::user()->second_last_name}}</span>
                    ...
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            @switch(Auth::user()->type)
                                ...
                                @break
                                @case(3)
                                @include('layouts.users_dashboard.student')
                                @break
                                @case(5)
                                @include('layouts.users_dashboard.tutors')
                                @break
                                @default
                                <span></span>
                                @endswitch
                        ...
                        doc['footer']=(function(page, pages) {
                            return {
                                ...
                                columns: [
                                    {
                                        alignment: 'left',
                                        text: ['Total de '+getName('{{ $view_name }}')+": "+total_registros],
                                        margin: [30,20]
                                    },
                                    {
                                        alignment: 'right',
